      ...
      <main className="max-w-4xl mx-auto px-6 pt-24 pb-32">
        ...
        <section className="mt-16 border-t border-earth-200 pt-12 text-center">
          ...
          <p className="text-basanite-600 text-base mb-6 max-w-xl mx-auto">
            Register your interest and we&rsquo;ll be in touch. We will run a real adaptive interview against a sample CV and walk you through the report side by side with a HireVue export if you bring one.
          </p>
          <a
