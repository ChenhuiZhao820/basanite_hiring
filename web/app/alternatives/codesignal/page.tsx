      ...
      <main className="max-w-4xl mx-auto px-6 pt-24 pb-32">
        ...
        <section className="mt-16 border-t border-earth-200 pt-12 text-center">
          ...
          <p className="text-basanite-600 text-base mb-6 max-w-xl mx-auto">
            Register your interest and we&rsquo;ll be in touch. Bring a sample CodeSignal report if you have one — we will sit Basanite next to it and walk you through what the dimensional report adds.
          </p>
          <a
