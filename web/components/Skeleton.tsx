  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
        {[1, 2, 3, 4].map(i => (
          <div key={i} className="bg-white dark:bg-basanite-900 border border-earth-200 dark:border-basanite-800 p-5 space-y-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {[1, 2, 3].map(i => (
          <div key={i} className="border border-earth-200 dark:border-basanite-800 bg-white dark:bg-basanite-900 p-6 space-y-3">
...
export function IntegrationsSkeleton() {
  return (
    <div className="max-w-4xl">
      ...
      <div className="bg-white dark:bg-basanite-900 border border-slate-200 dark:border-basanite-800 p-6 mb-6 space-y-4">
      ...
      <div className="bg-white dark:bg-basanite-900 border border-slate-200 dark:border-basanite-800 p-6 space-y-3">
        <Pulse className="h-4 w-56" />
        {[1, 2, 3, 4].map(i => (
          <div key={i} className="flex items-center justify-between border-b border-slate-100 dark:border-basanite-800 py-3">
            <div className="space-y-2">
...
export function RoleDetailSkeleton() {
  return (
    <div>
      ...
      <div className="border border-earth-200 dark:border-basanite-800 bg-white dark:bg-basanite-900 p-5 mb-8 space-y-2">
        <Pulse className="h-3 w-32" />
